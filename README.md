...
Кроме того, использование данного форка основного репозитория Яндекса без уведомления его мейнтейнера ([Dmitry Orlov](mailto:feanarokurufinve@gmail.com)) категорически запрещается. За любые последствия такого использования авторы форка ответственности не несут.
